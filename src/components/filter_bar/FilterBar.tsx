...
const sortByOptions = [
  {key: SORT_BY.TITLE, text: 'Título'},
  {key: SORT_BY.YEAR, text: 'Año'},
  {key: SORT_BY.RUNTIME, text: 'Duración de la película'}
];
interface Props {
  total: number;
  activePage: number;
    ...
    return (
      <styled.wrapper>
        <styled.sortByContainer xs={{span: 4, order: 1}} md={{span: 2, order: 1}} xl={{span: 2, order: 1}}>
          <DropdownButton title="Ordenar por: " id="sort-by-dropdown">
        ...
        <styled.searchContainer xs={{span: 12, order: 3}} md={{span: 9, order: 2}} xl={{span: 4, order: 2}}>
          ...
          <styled.searchActionButton onClick={onSearchHandler}>Buscar</styled.searchActionButton>
